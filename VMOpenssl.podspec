#
# Be sure to run `pod lib lint VMOpenssl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'VMOpenssl'
  s.version          = '0.1.0'
  s.summary          = 'A short description of VMOpenssl.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://git.vmovier.cc/users/chengqihan/repos/vmopenssl/browse'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Chengqihan' => 'chengqh@vmovier.com' }
  s.source           = { :git => 'https://chengqihan@git.vmovier.cc/scm/~chengqihan/vmopenssl.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'VMOpenssl' => ['VMOpenssl/Assets/*.png']
  # }
